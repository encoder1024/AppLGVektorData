...
// 1. Componente con animaciones fijas (Fuego, Tuberías, Gases)
// Se envuelve en memo con una función que siempre devuelve true para que NUNCA se re-renderice
const CalderaFondoAnimado = memo(() => {
  return (
    <g>
      {/* Animación del Fuego */}
      <motion.g
        initial={{ rotate: 90, x: 50, y: -50, scaleX: 0.7, scaleY: 0.15 }}
        style={{ originX: "126px", originY: "507px" }}
      >
        <motion.path
      ...
      {/* Animaciones de Tuberías */}
      <motion.path
        d="M372.053138,310.369927l-.253773,108.150351c-.102921.926899.442385,2.44042,1.11187,3.017932.534271.94461,2.142678,1.773171,3.17677,1.747222l196.980445.079182c2.332316.290149,4.432351-2.725923,4.745241-5.377941l-.360462-223.488267-4.393224-4.393224-64.922083-.488136c-3.959572.693395-8.923653-1.825908-8.298311-8.298311-.508406-4.789239,3.346063-9.864268,8.786447-9.274583h198.1832"
        stroke="#3f5787" strokeWidth="3" fill="none" strokeLinecap="round" strokeDasharray="10 5"
        transform="translate(0 0) scale(1.248)"
        animate={{ strokeDashoffset: [0, 15] }}
        transition={{ repeat: Infinity, duration: 0.5, ease: "linear" }}
      />
      <motion.path
        d="M301.53584,195.826312l-.586238-55.692596c.623344-1.756911-1.639926-5.385954-5.276141-5.27614l-242.383553-.441029"
        stroke="#c55c6a" strokeWidth="3" fill="none" strokeLinecap="round" strokeDasharray="10 5"
        transform="translate(0 0) scale(1.248)"
        animate={{ strokeDashoffset: [0, -15] }}
        transition={{ repeat: Infinity, duration: 0.5, ease: "linear" }}
      />
      <motion.path
        d="M14.937247,244.863127h138.660547c2.671821.93715,5.08849,3.377894,4.37218,4.996777l-.021017,84.766219"
        stroke="#fda901" strokeWidth="3" fill="none" strokeLinecap="round" strokeDasharray="10 5"
        transform="translate(0 0) scale(1.248)"
        animate={{ strokeDashoffset: [0, -15] }}
        transition={{ repeat: Infinity, duration: 0.5, ease: "linear" }}
      />
      <motion.path
        d="M16.517708,447.609711l136.985358.250889c2.230163.102904,4.741074-1.556709,4.265112-4.265113l.250889-32.866451"
        stroke="#8eadea" strokeWidth="3" fill="none" strokeLinecap="round" strokeDasharray="10 5"
        transform="translate(0 0) scale(1.248)"
        animate={{ strokeDashoffset: [0, -15] }}
        transition={{ repeat: Infinity, duration: 0.5, ease: "linear" }}
      />
      {/* Salida de Gases - Lineas Animadas */}
      <motion.path
        d="M451.974864,360.095698l27.910551.193823c5.363207-1.018516,10.34144-5.991596,10.078809-9.884988l.193823-25.003201c.143005-4.612195-3.769847-11.482404-10.078813-12.017043h-11.629395"
        stroke="#8eadea" strokeWidth="6" fill="none" strokeDasharray="5 3"
        transform="translate(0 0) scale(1.248)"
      ...
      <motion.path
        d="M451.974864,360.095698l27.910551.193823c5.363207-1.018516,10.34144-5.991596,10.078809-9.884988l.193823-25.003201c.143005-4.612195-3.769847-11.482404-10.078813-12.017043h-11.629395"
        stroke="#8eadea" strokeWidth="6" fill="none" strokeDasharray="5 3"
        transform="translate(0 0) scale(1.248) matrix(-1 0 0 1 706.109448 -55.067938)"
        animate={{ strokeDashoffset: [0, -16] }}
        transition={{ repeat: Infinity, duration: 0.5, ease: "linear" }}
      />
        {/* Gases de Salida del boiler distribución de gases */}
      <motion.path
        d="M528.641789,64.814418l-.362681,203.30896-7.42637,4.791206-128.562692.103355"
        stroke="#8eadea" strokeWidth="3" fill="none" strokeDasharray="5 3"
        transform="translate(0 0) scale(1.248)"
        animate={{ strokeDashoffset: [0, 16] }}
        transition={{ repeat: Infinity, duration: 0.5, ease: "linear" }}
      />
        {/* Gases de Salida del boiler salida del fuego */}
      <motion.path
        d="M370.589349,257.64661l149.305149.175677l8.62417-6.228567"
        stroke="#8eadea" strokeWidth="3" fill="none" strokeDasharray="5 3"
        transform="translate(0 0) scale(1.248)"
        animate={{ strokeDashoffset: [0, -16] }}
        transition={{ repeat: Infinity, duration: 0.5, ease: "linear" }}
      />
      <motion.path
        d="M298.705786,241.823185l221.188712,1.385925l8.38461-6.468127"
        stroke="#8eadea" strokeWidth="3" fill="none" strokeDasharray="5 3"
        transform="translate(0 0) scale(1.248)"
        animate={{ strokeDashoffset: [0, -16] }}
        transition={{ repeat: Infinity, duration: 0.5, ease: "linear" }}
...
export const CalderaInteractiva = memo(({ datosSensores }) => {
  ...
  return (
    <div style={{ position: "relative", width: "100%", maxWidth: "900px" }}>
      ...
      >
        {/* Capa estática animada (Nunca se re-renderize para evitar parpadeos) */}
        <CalderaFondoAnimado />
